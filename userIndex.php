	...
	<div class="main">
		...
		<div class="mainmenu">
			<ul>
				...
				<li style="float:right"><a href="contactus.php">Cart</a></li> 
			</ul>
		</div>
		<div class="main_content">
			...
			<div class="responsive">
				<div class="gallery">
					<a target="_blank" href="painting.html">
			...
			<div class="responsive">
				<div class="gallery">
					<a target="_blank" href="sculpture.html">
			...
			<div class="responsive">
				<div class="gallery">
					<a target="_blank" href="photography.html">
			...
			<div class="responsive">
				<div class="gallery">
					<a target="_blank" href="abstractArt.html">
			...
			<div class="responsive">
				<div class="gallery">
					<a target="_blank" href="artPrinting.html">
			...
			<div class="responsive">
				<div class="gallery">
					<a target="_blank" href="artist.html">
